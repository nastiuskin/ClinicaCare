...
{
    public record DeleteMedicalProcedureCommand(Guid id)
        : ICommand<Result>;

    public class DeleteMedicalProcedureCommandHandler
        : ICommandHandler<DeleteMedicalProcedureCommand, Result>
    {
        ...
        public async Task<Result> Handle(DeleteMedicalProcedureCommand command,
